...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     *
     * @return \PPP\Stripe\ErrorObject|null
     */
     ...
     *
     * @param \PPP\Stripe\ErrorObject|null $error
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \PPP\Stripe\ErrorObject} for possible
     * values.
     *
     * @return string|null
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \PPP\Stripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
